-- Evita que dos pestañas o efectos concurrentes creen dos organizaciones para
-- el mismo usuario durante el primer arranque.
...
begin
  ...
  -- Serializa exclusivamente la inicialización de este usuario.
